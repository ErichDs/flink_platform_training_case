...
import org.apache.flink.util.Collector // import TypeInformation for the data of your DataStreams
...
//      }
  ...
  def demoExplicitTransformations(): Unit = {
    ...
    // KeyedStream for every element we attach a key
    val keyedNumbers: KeyedStream[Long, Boolean] =
      numbers.keyBy(n => n % 2 == 0)
